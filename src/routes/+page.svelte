...
<section class="hero">
	<h1>WebGG</h1>
	<p>A collection of Babylon.js games and experiments.</p>
</section>

<section class="games">
	{#each games as game (game.id)}
		<a href={resolve(game.path)} class="card">
			<h2>{game.title}</h2>
...
<style>
	...
	.hero h1 {
		...
		text-shadow: var(--glow-secondary-lg);
		letter-spacing: 4px;
	}
	...
	.card h2 {
		...
		margin-bottom: 0.5rem;
		text-shadow: var(--glow-primary-md);
	}
